...
from transforms import shift_start, scale_to_max
...
val_frac = 5
attn = options.atten
model_num = f"ShiftMax22_{options.region}_{options.curr}"
# model_num = 22
...
full_x, full_x_mask = scale_to_max(full_x.squeeze(-1), full_x_test.squeeze())
full_x = full_x[:, :, None]
